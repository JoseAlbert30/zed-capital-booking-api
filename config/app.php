...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This URL is used for generating storage file URLs that are accessed
    | through the frontend domain. The frontend proxies /storage/ requests
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | URL of the frontend application for generating magic links
    |
    */
