    ...
    public function uploadAttachment(Request $request, $id)
    {
        try {
            ...
            $typeLabels = [
                ...
                'service_charge_ack_buyer' => 'Service Charge Acknowledgement (Buyer)',
                'service_charge_ack_developer' => 'Service Charge Acknowledgement (Developer)',
                'developer_noc' => 'Developer NOC',
                'developer_noc_signed' => 'Developer NOC (Signed)',
                'bank_noc' => 'Bank NOC',
                'finance_clearance' => 'Finance Clearance',
                'title_deed' => 'Title Deed',
                'sale_agreement' => 'Sale Agreement',
                'poa_document' => 'Power of Attorney (POA)',
                'attorney_id_document' => 'Attorney ID Document',
                'passport' => 'Passport Copy',
                'emirates_id' => 'Emirates ID',
                'soa' => 'Statement of Account',
                'handover_checklist' => 'Handover Checklist',
                'handover_declaration' => 'Handover Declaration',
