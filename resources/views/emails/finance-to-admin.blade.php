...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .alert-box h4 { color: #000000; font-size: 14px; margin-bottom: 10px; font-weight: 600; }
        .urgent-box { background-color: #fff3e0; border-left: 4px solid #ff9800; padding: 20px; margin: 25px 0; }
        .urgent-box h4 { color: #000000; font-size: 14px; margin-bottom: 10px; font-weight: 600; }
    </style>
</head>
<body>
    @php
    ...
    <div class="email-container">
      ...
      <div class="logo-header">
        ...
        <!-- Content -->
        <div class="content">
            <div class="greeting">{{ $greeting ?? 'Admin Notification' }}</div>
            
            <p class="message">
                {{ $messageBody ?? 'A new action has been performed that requires your attention.' }}
            </p>
            ...
            @isset($additionalInfo)
                @if(isset($additionalInfo['type']) && $additionalInfo['type'] === 'urgent')
                    <div class="urgent-box">
                        <h4>{{ $additionalInfo['title'] ?? 'Urgent Action Required' }}:</h4>
            ...
            <p class="message">
                Best regards,<br>
                <strong>Zed Capital Finance System</strong>
            </p>
        </div>
