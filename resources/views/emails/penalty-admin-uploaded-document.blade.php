...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>The penalty document for <strong>Unit {{ $unitNumber }}</strong> in <strong>{{ $projectName }}</strong> has been uploaded by the administrator.</p>
            ...
            <div class="penalty-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><strong>AED {{ number_format($amount, 2) }}</strong></span>
                </div>
                @endif
            </div>

            <div class="success-note">
                <strong>Document Available:</strong> The penalty document has been uploaded and is ready for your review.
            </div>
            
            <p style="text-align: center;">
                <a href="{{ $magicLink }}" class="action-button">
                    View Penalty Document
                </a>
            </p>
            
            <p style="color: #6b7280; font-size: 14px;">
                Click the button above to access the finance portal and view the penalty document.
            </p>
        </div>
