...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .note-box { background-color: #fff8e1; border-left: 4px solid #ffa000; padding: 20px; margin: 25px 0; }
        .note-box h4 { color: #000000; font-size: 14px; margin-bottom: 10px; font-weight: 600; }
        .note-box ul { margin: 10px 0 0 20px; padding: 0; color: #666666; }
    </style>
</head>
<body>
    @php
