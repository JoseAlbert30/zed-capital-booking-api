...
<head>
    ...
    <title>NOC Document Uploaded</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>The developer <strong>{{ $developerName }}</strong> has uploaded an NOC document for <strong>Unit {{ $unitNumber }}</strong>.</p>
            ...
            <div class="info-box">
                <strong>📎 Document Available:</strong> The NOC document has been uploaded and is ready for review in the finance portal.
            </div>
