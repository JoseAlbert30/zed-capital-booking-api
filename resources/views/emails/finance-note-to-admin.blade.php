...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .message-box { background-color: #fff8e1; border-left: 4px solid #ffc107; padding: 20px; margin: 25px 0; border-radius: 0 4px 4px 0; }
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <div class="greeting">{{ $greeting ?? 'New Developer Note / Request' }}</div>
            ...
            <p style="color:#666666; font-size:13px; text-align:center;">
                Please log in to the admin portal to view the full thread and respond directly.
            </p>
        </div>
