...
<head>
    ...
    <style>
        ...
        @page {
            margin: 120px 35px 95px 35px; /* room for fixed header/footer */
        }
        ...
        * { font-family: DejaVu Sans, sans-serif; font-size: 11px; color: #000; }
        ...
        .footer-bar, .footer-bar * { color: #fff; }
        ...
        .sub-logo-text { font-size: 9px; letter-spacing: 2px; }

        .date-box { text-align: right; }
        .date-label { font-size: 11px; font-weight: bold; }
        .line {
        ...
        .info td { padding: 6px 0; vertical-align: middle; }
        .label { width: 28%; font-weight: bold; }
        .value { width: 72%; }

        .section-title { font-size: 13px; font-weight: bold; margin: 12px 0 8px; }
        .hr { height: 6px; background: #111; margin: 10px 0; }

        .check-table { width: 100%; border-collapse: collapse; }
        .check-table td { padding: 6px 0; vertical-align: middle; }
        .check-left { width: 43%; }
        .check-mid { width: 7%; text-align: center; }
        .check-right { width: 43%; }
        .check-end { width: 7%; text-align: center; }
        ...
        .note { font-size: 10px; font-style: italic; margin-top: 6px; }

        .row-4 { width: 100%; border-collapse: collapse; margin-top: 10px; }
        .row-4 td { padding: 6px 0; vertical-align: middle; }
        .row-4 .item { width: 22%; }
        .row-4 .box { width: 3%; text-align: center; }

        .remarks { width: 100%; border-collapse: collapse; margin-top: 6px; }
        .remarks td { padding: 6px 0; vertical-align: middle; }
        .remarks .r-label { width: 28%; }
        .remarks .r-line { width: 72%; }

        .receivables { width: 100%; border-collapse: collapse; margin-top: 8px; }
        .receivables td { padding: 8px 0; vertical-align: middle; }
        .receivables .r1 { width: 28%; }
        .receivables .r2 { width: 22%; }
        .receivables .r3 { width: 22%; }
        .receivables .r4 { width: 28%; }

        .decl { margin-top: 12px; }
        .sign-table { width: 100%; border-collapse: collapse; margin-top: 10px; }
        .sign-table td { padding: 8px 0; vertical-align: bottom; }
        .sign-name { width: 30%; font-weight: bold; }
        .sign-line { width: 40%; padding-right: 10px; }
        .sign-lbl { width: 10%; text-align: right; font-weight: bold; padding-right: 10px; }
        .sign-line2 { width: 20%; }
